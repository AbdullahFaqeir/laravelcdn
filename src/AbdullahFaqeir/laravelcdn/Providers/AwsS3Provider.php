 ...
 * @property string $credential_secrets
...
class AwsS3Provider extends Provider
{
    ...
    /**
     * @var \Aws\S3\S3ClientInterface of Aws\S3\S3Client
     */
    ...
    /**
     * @var \AbdullahFaqeir\LaravelCDN\Validators\Contracts\ProviderValidatorInterface
     */
    protected ProviderValidatorInterface $provider_validator;

    /**
     * @param \Symfony\Component\Console\Output\ConsoleOutput                            $console
     * @param \AbdullahFaqeir\LaravelCDN\Validators\Contracts\ProviderValidatorInterface $provider_validator
     * @param \AbdullahFaqeir\LaravelCDN\Contracts\CdnHelperInterface                    $cdn_helper
     */
     ...
     * @return $this
     */
    public function init(array $configurations): static
    {
     ...
     */
    public function setS3Client(S3ClientInterface $s3_client): void
    {
     ...
     * @return Collection
     */
    private function getFilesAlreadyOnBucket(Collection $assets): Collection
    {
     ...
     * @return string|bool
     */
    public function getCloudFront(): string|bool
    {
